...
#define LINUX_VERSION_CODE 396032 // SUSE Enterprise Desktop 15.7 has backported kernel 6.4 with patches from kernel 6.11. This is LINUX_VERSION_CODE of kernel version 6.11.0 for normal compilation.
